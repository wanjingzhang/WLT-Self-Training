var gesture = Bone.extend({}, Bone.Events, {
    ...
    clear: function () {
        ...
        this.stage.off('mousedown', this.onTouchStart);
        this.stage.off('mousemove', this.onTouchMove);
        this.stage.off('mouseup', this.onTouchEnd);

    },

    onTouchStart: function (evt) {
        this.firstDir = '';
        evt.type == 'mousedown' ? evt:evt = evt.changedTouches[0];
        ...
        this.stage.on('mousemove', this.onTouchMove);
        this.stage.on('mouseup', this.onTouchEnd);
        this.stage.on('mouseleave', this.onTouchEnd);
        
        this.trigger(this.START);
    },

    onTouchMove: function (evt) {
        evt.type == 'mousemove' ? evt : evt = evt.changedTouches[0]; 
    ...
    onTouchEnd: function () {
        ...
        this.stage.off('mousemove', this.onTouchMove);
        this.stage.off('mouseup', this.onTouchEnd);
        this.stage.off('mouseleave', this.onTouchEnd);
        return false;
    },
